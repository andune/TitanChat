...
public abstract class FormatVariable implements IVariable {
	
	private static final List<FormatVariable> variables = new ArrayList<FormatVariable>();
	
	public static final List<IVariable> getVariables() {
		return new ArrayList<IVariable>(variables);
	}
	
	public static final void register(FormatVariable variable) {
