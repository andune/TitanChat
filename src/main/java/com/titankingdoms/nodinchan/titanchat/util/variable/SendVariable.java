...
public abstract class SendVariable implements IVariable {
	
	private static final List<SendVariable> variables = new ArrayList<SendVariable>();
	
	public static final List<IVariable> getVariables() {
		return new ArrayList<IVariable>(variables);
	}
	
	public static final void register(SendVariable variable) {
